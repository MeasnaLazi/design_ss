...
**Location:** [`datasource/temp/design_brief.json`](../datasource/temp/design_brief.json) (created/updated by agents; ignored by git unless you add a `!` exception in `.gitignore`).
