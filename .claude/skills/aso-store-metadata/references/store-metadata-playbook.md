# Store metadata playbook

Used by **app_optimizer** when generating **`output/appstore.json`** and **`output/playstore.json`**.

## Step 1 — Analyze the project

Read from the given project path:
...
Fields map to App Store Connect and Google Play Console, and are compatible with Fastlane `deliver` (iOS) and Fastlane `supply` (Android).
