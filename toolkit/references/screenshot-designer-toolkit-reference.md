...
- Use only:
  - `python toolkit/scripts/layout.py ...`
  - `python toolkit/scripts/designer.py ...`
...
Global `--compact` must appear immediately after `layout.py` / `designer.py` (before subcommands).
...
`python toolkit/scripts/designer.py enqueue-op --operation <op> --args-json '{...}'`
...
```bash
python toolkit/scripts/designer.py enqueue-op --operation layer_patch --args-json '{
...
```bash
python toolkit/scripts/designer.py enqueue-op --operation layers_patch_bulk --args-json '{
  "panel_index":0,
  "layers":[
...
```bash
python toolkit/scripts/designer.py enqueue-op --operation batch --args-json '{
  "operations":[
...
```bash
python toolkit/scripts/designer.py enqueue-op --operation set_z_index --args-json '{
