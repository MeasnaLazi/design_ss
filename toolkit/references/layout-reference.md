...
**Hybrid validation** (`designer.py validate-rules`, `validate-strip-rules`, rules-then-vision workflow): **`design-validate.md`**. **`layout contrast`** is optional manual math only.
