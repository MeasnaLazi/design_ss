...
# Same platform → store file + preset mapping as the screenshot agents (see .claude/skills/screenshot-docs/references/screenshot_design_brief.md / layout store-json).
